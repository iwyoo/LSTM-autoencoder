...
class SequentialLSTMAutoencoder(object):
  def __init__(self, hidden_num, inputs, 
    cell=None, optimizer=None, reverse=True):
    """Sequence version of LSTM-autoencoder.
    The decoder takes hidden codes of encoder cells.
    ...
    if reverse:
      dec_inputs = self.z_codes[::-1]
    else :
      dec_inputs = self.z_codes
